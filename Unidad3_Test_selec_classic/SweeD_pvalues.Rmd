...
**Esta línea es de bash no de R y NO corre si no tienes el programa instalado y los datos input. O sea la pongo como referencia para que sepas de donde salieron los datos output, pero no la debes correr**
