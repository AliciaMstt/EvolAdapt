...
* [El libro online de ggplot2](https://ggplot2-book.org/introduction.html)
...
**Ojo: Mucho mejor que ver la ayuda de cada función es ver el [R Graphics Cookbook](http://www.cookbook-r.com/Graphs/) u otros recursos en línea.**

El mejor recurso para aprender a usar ggplot2 a profundidad [El libro online de ggplot2](https://ggplot2-book.org/introduction.html)
...
**Ejercicio**: Lee el tutorial de [este link](https://statisticsglobe.com/ordered-bars-in-ggplot2-barchart-in-r) y utilizalo para repetir la gráfica anterior, pero ordenando los estados (ahorita están en orden alfabético, ponlos en cualquier otro orden que quieras).
